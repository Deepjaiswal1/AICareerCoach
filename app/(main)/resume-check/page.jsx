          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <Link href="/resume-check/resume-history">
              <Button
                variant="outline"
                size="lg"
                className="rounded-2xl border-2 border-border bg-card hover:bg-muted font-bold text-card-foreground h-14 px-8"
              >
              ...
              {!resumeText ? (
                ...
                >
                  ...
                  {isExtracting ? (
                    ...
                    <UploadCloud className="h-10 w-10 text-muted-foreground group-hover:text-primary mb-4 transition-colors" />
                  )}
            ...
            {loading ? (
              ...
              <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
                ...
                <div className="flex justify-end">
                  <Button
                    ...
                    variant="ghost"
                    className="text-muted-foreground hover:text-primary font-black text-[10px] uppercase tracking-widest gap-2"
                  >
                    ...
                    <div className="relative h-40 w-40 flex items-center justify-center shrink-0">
                      <svg className="h-full w-full -rotate-90">
                        ...
                        <circle
                          ...
                          strokeDasharray={440}
                          strokeDashoffset={
                            440 - (440 * result.matchPercentage) / 100
                          }
                          strokeLinecap="round"
                    ...
                    <div className="flex flex-wrap gap-2">
                      {result.missingKeywords?.length > 0 ? (
                        ...
                        <span className="text-xs text-muted-foreground italic">
                          No missing critical keywords detected.
                        </span>
                      )}
                    </div>
                  </Card>
                    ...
                    <ul className="space-y-3">
                      ...
                      result.formattingIssues.length > 0 ? (
                        result.formattingIssues.map((issue, i) => (
                          <li
                            key={i}
                            className="text-xs font-bold text-foreground flex items-start gap-2"
                          >
                ...
                <Card className="border-none bg-primary rounded-[2rem] p-8 text-primary-foreground shadow-xl">
                  ...
                  <div className="space-y-4">
                    {result.suggestions?.map((sug, i) => (
                      <div
                        key={i}
                        className="flex gap-5 p-5 bg-black/10 rounded-2xl border border-white/10 items-start"
                      >
              ...
              <div className="h-full min-h-[500px] flex flex-col items-center justify-center border-2 border-border rounded-[3rem] bg-muted/10 p-12 text-center">
                ...
                <p className="text-muted-foreground font-bold max-w-sm mb-10 leading-relaxed">
                  Upload your dossier and define target requirements to initiate
                  analysis.
                </p>
              </div>
            )}
