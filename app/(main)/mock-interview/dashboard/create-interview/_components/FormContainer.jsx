  ...
  return (
    <div className="p-5 bg-white rounded-xl">
      ...
      <div className="mt-5">
        ...
        >
          <SelectTrigger className="w-45 mt-2">
      ...
      <div className="mt-5">
        ...
        <div className="flex gap-3 flex-wrap mt-2">
          {InterviewType.map((type, index) => (
            <div
              key={index}
              className={`flex items-center cursor-pointer gap-2 p-1 px-2 bg-white border border-gray-300 rounded-2xl hover:bg-blue-100 ${interviewType.includes(type.title) && "text-blue-500"}`}
